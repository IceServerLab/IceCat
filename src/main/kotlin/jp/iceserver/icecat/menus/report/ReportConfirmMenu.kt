...
class ReportConfirmMenu(private val target: OfflinePlayer, private val reasons: List<String>) : InventoryProvider
{
    ...
    override fun init(player: Player, contents: InventoryContents)
    {
        ...
        contents.set(1, 2, ClickableItem.of({ i ->
            ...
            embedBuilder.setTitle(WebhookEmbed.EmbedTitle("レポートが届きました。", ""))
            embedBuilder.addField(WebhookEmbed.EmbedField(true, "報告者", player.name))
            ...
            messageBuilder.setUsername("IceServer Report")
            messageBuilder.setAvatarUrl("https://images-ext-2.discordapp.net/external/q35szkJdGNEokxVLNou1mnKqbFUIquR2O5xNBN3seu4/https/cdn.discordapp.com/icons/680934020992729090/7e7ba969e7f047b66caaf66493f0b3b3.png")
